            ...
            <div className="text-center space-y-8">
              ...
              <div className="relative">
                ...
                <div className="absolute inset-0 w-32 h-32 -m-4">
                  <div
                    className="absolute inset-0 rounded-full border-2 border-gradient-to-r from-purple-500/30 to-pink-500/30 animate-spin"
                    style={{ animationDuration: "3s" }}
                  ></div>
                  <div
                    className="absolute inset-2 rounded-full border border-gradient-to-r from-blue-500/20 to-cyan-500/20 animate-spin"
                    style={{
              ...
              <div className="w-full bg-muted/30 rounded-full h-3 overflow-hidden shadow-inner">
                <div
                  className="h-full bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 rounded-full shadow-lg animate-pulse"
                  style={{
                    width: "100%",
                    background:
