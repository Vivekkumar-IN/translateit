...
import { Download, Send, AlertTriangle, Loader2, Music, Globe, RotateCcw } from 'lucide-react';
            ...
            <div className="text-center space-y-8">
              ...
              <div className="relative">
                ...
                <div className="absolute inset-0 w-40 h-40 -m-6">
                  <div className="absolute inset-0 rounded-full border-2 border-purple-500/30 animate-spin" style={{ animationDuration: '4s' }}></div>
                  <div className="absolute inset-3 rounded-full border border-pink-500/20 animate-spin" style={{ animationDuration: '3s', animationDirection: 'reverse' }}></div>
                  <div className="absolute inset-6 rounded-full border border-blue-500/15 animate-spin" style={{ animationDuration: '2s' }}></div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <h3 className="text-2xl font-bold bg-gradient-to-r from-purple-600 via-pink-600 to-red-600 bg-clip-text text-transparent">
                  {isInitializing ? 'Initializing YukkiMusic Translator' : 'Restoring Previous Translation'}
                </h3>
                ...
                {foundTranslation && languageCode ? (
                  <div className="space-y-3">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-green-500/10 text-green-600 rounded-full border border-green-500/20">
                      ...
                      <span className="text-sm font-medium">Previous translation found!</span>
                    </div>
                    <p className="text-base text-muted-foreground">
                      Restoring <strong className="text-primary font-semibold">{languageCode.toUpperCase()}</strong> translation
                    </p>
                    <div className="flex items-center justify-center gap-3 text-sm">
                      <div className="flex items-center gap-2 px-3 py-1 bg-primary/10 text-primary rounded-full">
                        <div className="w-1.5 h-1.5 bg-primary rounded-full animate-pulse"></div>
                        <span><strong>{Object.keys(foundTranslation.translations).length}</strong> translations completed</span>
                      </div>
                    </div>
              ...
              <div className="w-full bg-muted/30 rounded-full h-3 overflow-hidden shadow-inner">
                <div className="h-full rounded-full shadow-lg animate-pulse" 
                     style={{ 
                       width: '100%',
