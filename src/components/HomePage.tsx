        ...
        <div className="text-center space-y-8 mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Transform YukkiMusic into any language with our powerful, user-friendly translation tool. 
              Make music accessible to everyone, everywhere.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: "Work through the translation keys at your own pace with our intuitive interface",
                color: "from-purple-500 to-pink-500"
              },
              {
                step: "3",
                title: "Export & Share",
                description: "Download your completed translation or send it directly to the development team",
                color: "from-green-500 to-emerald-500"
              }
            ].map((item, index) => (
              <div key={index} className="text-center space-y-4">
                <div className={`w-16 h-16 bg-gradient-to-br ${item.color} rounded-full flex items-center justify-center mx-auto shadow-lg`}>
        ...
        <div className="mt-16 mb-8">
          <div className="bg-gradient-to-r from-purple-500/10 via-pink-500/10 to-red-500/10 rounded-2xl sm:rounded-3xl p-6 sm:p-12 border border-purple-500/20 text-center">
            ...
            <p className="text-base sm:text-lg text-muted-foreground mb-6 sm:mb-8 max-w-2xl mx-auto leading-relaxed">
              Join our community of translators and help bring the joy of music to people around the world in their native language.
            </p>
